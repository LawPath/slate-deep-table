...
import insertTableByKey from "./changes/insertTableByKey";
import insertTableByPath from "./changes/insertTableByPath";
...
import moveTableSelection from "./changes/moveSelection";
import moveTableSelectionBy from "./changes/moveSelectionBy";
import toggleTableHeaders from "./changes/toggleHeaders";
import toggleTableBorders from "./changes/toggleBorders";
import TablePosition from "./TablePosition";
import onTab from "./onTab";
import onUpDown from "./onUpDown";
import makeSchema from "./makeSchema";
import makeRenderers from "./defaultRenderers";
import makeSerializerRules from "./defaultSerializers";
...
function EditTable(opts) {
  ...
  return {
    ...
    commands: {
      ...
      toggleTableBorders: bindEditor(toggleTableBorders),
    },
  };
}
